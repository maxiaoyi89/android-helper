...
public class MD5Util {
	...
	public static String getMD5WithSalt(String data) {
        return getMD5WithSalt(data.getBytes());
    }
	 ...
	 * @return 密文
	 */
	public static String getMD5WithSalt(byte[] data) {
        ...
        try {
            ...
            byte[] digest = md.digest();
            // 把密文转换成十六进制的字符串形式
            return new String(bytes2HexWithSalt(digest));
        } catch (NoSuchAlgorithmException e) {
			e.printStackTrace();
		}  
		return "";
     ...
     * 一个byte转为2个hex字符, 加盐
     */
    private static String bytes2HexWithSalt(byte[] src) {
